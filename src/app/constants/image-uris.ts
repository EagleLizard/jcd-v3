...
export const JANU = imageUri('bio-janice.jpg');

export const PLACEHOLDER = imageUri('bigbird.jpg');
export const RENAISSANCE_FAIRE = imageUri('utahrenaissancefaire.png');
export const BYU = imageUri('brighamyounguniversity.jpg');
export const SUNDANCE = imageUri('sundancesummertheatre.jpg');
export const RENAISSANCE_NOW = imageUri('renaissancenow.jpg');
export const UVU = imageUri('utahvalleyuniversity.jpg');
export const FAT_PIG = imageUri('fatpig.jpg');
export const TRIBES = imageUri('tribes.jpg');
export const AGAMEMNON = imageUri('agamemnon.jpg');
export const NEXT_FALL = imageUri('nextfall.jpg');
export const CABARET = imageUri('cabaret.jpg');
export const THE_DRAG = imageUri('thedrag.jpg');
export const LARAMIE = imageUri('laramie_min.jpg');
...
export const URINETOWN_GALLERY = imageUris([
...
export const MRBURNS_GALLERY = imageUris([
...
export const LARAMIE_GALLERY = imageUris([
...
export const THE_DRAG_GALLERY = imageUris([
...
export const CABARET_GALLERY = imageUris([
...
export const NEXT_FALL_GALLERY = imageUris([
...
export const AGAMEMNON_GALLERY = imageUris([
...
export const TRIBES_GALLERY = imageUris([
  'tribes/tribes1.jpg',
  'tribes/tribes2.jpg',
  'tribes/tribes3.jpg',
  'tribes/tribes4.jpg',
...
export const FAT_PIG_GALLERY = imageUris([
  'fatpig/fatpig1.jpg',
  'fatpig/fatpig2.jpg',
  'fatpig/fatpig3.jpg',
  'fatpig/fatpig4.jpg',
...
export const UVU_GALLERY = imageUris([
  'uvu/uvu1.jpg',
  'uvu/uvu2.jpg',
  'uvu/uvu3.jpg',
  'uvu/uvu4.jpg',
...
export const SUNDANCE_GALLERY = imageUris([
...
export const RENAISSANCE_NOW_GALLERY = imageUris([
...
export const BYU_GALLERY = imageUris([
  'byu/BYU1.jpg',
  'byu/BYU2.jpg',
  'byu/BYU3.jpg',
  'byu/BYU4.jpg',
...
export const RENAISSANCE_FAIRE_GALLERY = imageUris([
  'renaissancefaire/renaissancefaire1.jpg',
  'renaissancefaire/renaissancefaire2.jpg',
  'renaissancefaire/Shield1.png',
  'renaissancefaire/Shield2.png',
